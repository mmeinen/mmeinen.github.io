...
- [x] **ENM-04**: Sniper enemy archetype — stays at extreme range, fires accurate shots, low HP (introduced wave 8)
- [x] **ENM-05**: Capital enemy archetype — large, slow, high HP, spawns Grunt minions as mini-boss (introduced wave 10+)
...
- [x] **ENM-08**: Boss waves appear every N waves as special encounters
...
- [x] **DEF-02**: Player ship is destroyed with an explosion when hull reaches zero
...
- [x] **HUD-01**: Weapon status panel showing all 4 weapons with selected weapon highlighted
